                                ...
                                <div class="">
                                    <table id="" class="table table-bordered">
                                        ...
                                        <tbody >
                                            <?php
                                           $no = 1;
                                           $query_widget = mysql_query("select a.*, b.menu_name, b.menu_type_id from widget_tmp a 
                                               ...
                                               <td width="20%"><?= $row_widget['jumlah']?></td>
                                                <td><?= $row_widget['menu_name']?></td>
                                                  <td style="text-align:center;">
                                                    ...
                                                    <a href="transaction_new.php?page=note&table_id=<?= $table_id?>&wt_id=<?= $row_widget['wt_id']?>&type=<?= $row_widget['menu_type_id']?>" class="btn btn-default" ><i class="fa fa-edit"></i></a>
