...
<html>
    <head>
        <meta charset="UTF-8">
        <title>.: Hong Li Huo Guo Cheng :.</title>
                                     ...
                                     <b> Voucher</b>
                                      <br>
                                       <select  id="basic" name="i_voucher_id" size="1" class="selectpicker show-tick form-control" data-live-search="true" style="min-height:100px;" onchange="update_voucher(this.value)" />
                                           ...
                                           <?php
                                            $q_voucher = mysql_query("select * from vouchers order by voucher_id");
                                            while($r_voucher = mysql_fetch_array($q_voucher)){
                                            ?>
                                             <option value="<?= $r_voucher['voucher_id'] ?>"><? if($r_voucher['voucher_type_id'] == 1){ echo $r_voucher['voucher_code']." ( Rp. ". $r_voucher['voucher_value']." )";}else{ echo $r_voucher['voucher_code']." ( ". $r_voucher['voucher_value']."  %)" ;}  ?></option>
                                             <?php
                                             }
                                             ?>
                                           </select>    
                                    ...
                                    <div class="col-md-12" style="padding:0px;">
                                      <div class="payment_group">
                                        ...
                                        <b>Nominal</b>
                                         ...
                                         <input required type="text" name="i_payment" id="i_payment" class="form-control calc_nominal" value="<?= ($totalkedua) ?>" style="text-align:right; font-size:20px;" onChange="update_change()"/>
                                         ...
                                         <tfoot>
                                            ...
                                            <tr>
                                              <td colspan="3" style="text-align:right; font-size:20px;" ><?= number_format($totalawal)?> 
                                                 <input required type="hidden" name="i_total" id="i_total" class="form-control" value="<?= $totalawal?>" style="text-align:right; font-size:30px; height:50px;" readonly/>
                                                </td>
                                            </tr>
											<tr>
                                                <td colspan="2" width="50%">Service Charge (5%)</td>
                                            </tr>
                                            <tr>
                                              <td colspan="3" style="text-align:right; font-size:20px;" ><?= number_format($svc)?> 
                                                 <input required type="hidden" name="i_totalcharge" id="i_totalcharge" class="form-control" value="<?= $svc?>" style="text-align:right; font-size:30px; height:50px;" readonly/>
                                                </td>
                                            </tr>
											<tr>
                                            ...
                                            <tr>
                                              <td colspan="3" style="text-align:right; font-size:20px;" ><?= number_format($tax)?> 
                                                 <input required type="hidden" name="i_totaltax" id="i_totaltax" class="form-control" value="<?= $tax?>" style="text-align:right; font-size:30px; height:50px;" readonly/>
                                                </td>
                                            </tr>
                                            <tr>
                                        ...
                                        <tbody>
                                         ...
                                         <tfoot>
											...
											<tr>
                                                ...
                                                <td colspan="3" style="text-align:right;" ><?= number_format($svc)?> 
                                                 </td>
                                            ...
                                            <tr>
                                            <td colspan="5"><a href="print_bill.php?table_id=<?=$table_id?>$building_id=<?=$building_id?>" target="_blank" class="btn button_save_payment btn-block"><i class="fa fa-print"></i>Print Bill</a> </td>
                                            </tr>
                                        </tfoot>
 ...
 <!-- page script -->
    ...
    function update_discount(){
       ...
       var discount = discountvalue/100*total;
        ...
        var grand_total = total - discount + tax +charge;
