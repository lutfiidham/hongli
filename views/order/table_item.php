...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="17%"><a href="transaction_new.php?page=list&table_id=<?= $row['table_id']?>" style="text-decoration:none;"><div class="btn_edit_item">EDIT </div></a></td>
    <td width="20%">
    ...
    <td width="20%">
		<a href="print_order.php?table_id=<?= $row['table_id']?>&building_id=<?= $building_id?>&type=0" style="text-decoration:none;"><div class="btn_print">Dapur</div></a>
    </td>
	<td width="19%">
		<a href="print_order.php?table_id=<?= $row['table_id']?>&building_id=<?= $building_id?>&type=4" style="text-decoration:none;"><div class="btn_print">Bar</div></a>
    </td>
  </tr>
</table>
</span>
