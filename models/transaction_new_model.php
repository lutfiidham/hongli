...
function select_widget($user_id, $table_id){
	$query = mysql_query("select * from widget_tmp where table_id = '$table_id'");
	return $query;
}
...
function get_transaction_id_old($table_id, $i_tot_id){
	$query = mysql_query("select transaction_id
							  from transactions_tmp
							  where table_id = '".$table_id."'
							  ");
	mysql_query("update transactions_tmp set tot_id = '".$i_tot_id."'
							  where table_id = '".$table_id."'
							  ");
	$row = mysql_fetch_array($query);
...
function get_all_item($table_id){
...
function get_menu_price($menu_id){
	$query = mysql_query("select menu_price as result
							from menus
							where menu_id = '".$menu_id."'
							  ");
	$row = mysql_fetch_array($query);
